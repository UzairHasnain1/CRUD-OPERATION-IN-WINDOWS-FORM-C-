...
namespace CarModels
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("insert into tblCarDetails(Names,Model,Years of Manufacture) values(@name,@model,@years of manufacture)", con);
                con.Open();
                cmd.Parameters.AddWithValue("@name", textBox1.Text);
                cmd.Parameters.AddWithValue("@model", textBox3.Text);
                cmd.Parameters.AddWithValue("@years of manufacture", textBox2.Text);
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "")
            {
                SqlCommand cmd = new SqlCommand("update tblCarDetails set Names=@name,Model=@model,Years of Manufacture=@year where id=@Id", con);
                con.Open();
